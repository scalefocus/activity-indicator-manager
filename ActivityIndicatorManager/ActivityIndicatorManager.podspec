...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://bitbucket.upnetix.com/users/dimitar.petrov/repos/activity-indicator-manager/browse"
  ...
  # Or just: spec.author    = "Dimitar Valentinov Petrov"
  # spec.authors            = { "Dimitar Valentinov Petrov" => "dimitar.petrov@upnetix.com" }
  # spec.social_media_url   = "https://twitter.com/Dimitar Valentinov Petrov"
  ...
  spec.source       = { :git => "https://bitbucket.upnetix.com/users/dimitar.petrov/repos/activity-indicator-manager/browse/ActivityIndicatorManager?at=refs%2Fheads%2Fdevelop.git", :tag => "0.0.1" }
  # spec.source       = { :git => "http://EXAMPLE/ActivityIndicatorManager.git", :tag => "#{spec.version}" }
